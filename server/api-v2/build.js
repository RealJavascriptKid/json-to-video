...
const build = async (compositionId = 'myvid', videoDir, onProgress) => {
  // The composition you want to render
  // const compositionId = id;

  // You only have to do this once, you can reuse the bundle.
  //const entry = path.join(videoDir, 'index.js');
  let entry = videoDir || path.join(__dirname + '/../../src','api2vid.jsx');
  ...
  try{
    ...
    await renderMedia({
      ...
      console.error("Error while render media:",ex.message)
